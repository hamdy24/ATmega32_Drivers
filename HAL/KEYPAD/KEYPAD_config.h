...
/********** Rows Configuration ***********/
#define ROW1_PORT		DIO_u8PORTD
#define ROW1_PIN		DIO_u8PIN0

#define ROW2_PORT		DIO_u8PORTD
#define ROW2_PIN		DIO_u8PIN1

#define ROW3_PORT		DIO_u8PORTD
#define ROW3_PIN		DIO_u8PIN2

#define ROW4_PORT		DIO_u8PORTD
#define ROW4_PIN		DIO_u8PIN3
/************* Columns Configuration ************/

#define COL1_PORT		DIO_u8PORTD
#define COL1_PIN		DIO_u8PIN4

#define COL2_PORT		DIO_u8PORTD
#define COL2_PIN		DIO_u8PIN5

#define COL3_PORT		DIO_u8PORTD
#define COL3_PIN		DIO_u8PIN6

#define COL4_PORT		DIO_u8PORTD
