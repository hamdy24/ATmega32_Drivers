...
/* Use DIO Initialization only if you want to configure Pins from the Dio_config.h file
 * else you can use the other interfaces for other configuration options
 */
